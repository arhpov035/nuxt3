  ...
  <div class="flex">
    ...
    <div class="conditer-description">
      ...
      <p class="text-gray-600">
        ...
        высококачественных ингредиентов, придерживаясь традиционных рецептов. Её
        творения всегда получают высокие оценки и одобрение клиентов, которые
        ценят высочайшее качество и исключительный вкус. Заказывайте торты и
        капкейки у нашего кондитера и получайте незабываемые восторженные
        впечатления от каждой десертной начинки.
      </p>
    </div>
  </div>
</template>
